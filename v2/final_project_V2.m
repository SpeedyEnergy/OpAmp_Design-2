...
if pmos.option == 1 || pmos.printall == 1
    ...
    ylabel('g_{m}/g_{ds}');
    legend('65nm','80nm','100nm','150nm','200nm','400nm','500nm','1um');
    title('g_{m}/g_{ds} in function of V_{ov}(w=10L,Vds=-0.3V). PMOS');
end
...
if pmos.option == 2 || pmos.printall == 1
    ...
    ylabel('g_{m}/g_{ds}');
    legend('65nm','80nm','100nm','150nm','200nm','400nm','500nm','1um');
    title('g_{m}/g_{ds} in function of V_{GS}(w=10L,Vds=-0.3V). PMOS');
end
...
if pmos.option == 3 || pmos.printall == 1
    ...
    ylabel('g_{m}/I_{ds} [1/V]');
    legend('65nm','80nm','100nm','150nm','200nm','400nm','500nm','1um');
    title('g_{m}/I_{ds} in function of V_{ov}(w=10L,Vds=-0.3V). PMOS');
end
end
...
Vout_wp = spec.VDD/2;%(1.1-0.2+Mn6.vov)/2;%(1.1-0.2 + 0.17)/2;
Mn6.vsb = 0;
Mn6.vds = Vout_wp;
Mn6.vth = tableValueWref('vth', NRVT, Mn6.lg, 0, Mn6.vds, Mn6.vsb);
...
Vcm_in_min = Mp1.vgs - Mp1.vov + Mn4.vov

Vcm = 0.32;%(Vcm_in_max + Vcm_in_min) / 2;
